"""This program creates a series of frames based on t, in the recursive art function."""
...
def evaluate_random_function(f, x, y, t):
	...
	if f[0] == "x":
		...
		return t
	#These are the three basic functions, that will always be used eventually
...
def generate_art(filename, x_size=350, y_size=350, frames=100):
	...
	for k in range (frames):
		...
		im.save("./movie_frames" + filename + str(k) + '.png')
